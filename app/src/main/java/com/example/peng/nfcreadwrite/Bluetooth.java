...
public class Bluetooth extends AppCompatActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //UI
        bSend = (Button) findViewById(R.id.button9);
        lv = (ListView)findViewById(R.id.listView);
        et = (TextView)findViewById(R.id.editText);
        cbServer = (CheckBox)findViewById(R.id.checkBox);
    ...
    public void closeBT(View v)
    {
        ...
        et.setText("Write a message here . . . ");
    }
    ...
    public void selectBTdevice(String name)
    {
